#!/bin/bash
# MyStory Lightroom Tagger — Installer
...
# If run from the .app bundle, look inside Contents/Resources
if [[ "$SRC_DIR" == *.app/Contents/Resources ]]; then
  SRC_DIR="$SRC_DIR"
elif [[ -d "$SRC_DIR/MyStory Installer.app/Contents/Resources" ]]; then
  SRC_DIR="$SRC_DIR/MyStory Installer.app/Contents/Resources"
fi

echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║   MyStory Lightroom Tagger — Installer       ║"
echo "╚══════════════════════════════════════════════╝"
echo ""
